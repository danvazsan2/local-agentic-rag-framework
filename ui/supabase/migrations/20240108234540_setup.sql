...
AS $$
DECLARE
  project_url TEXT := 'https://waskpygibcpzdfubtklu.supabase.co';
  service_role_key TEXT := '<YOUR_SUPABASE_SERVICE_ROLE_KEY>'; -- full access needed for http request to storage
