  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <WithTooltip
          display={<div>Configuración del workspace</div>}
          trigger={
            <IconSettings
        ...
        <div className="grow overflow-auto">
          <SheetHeader>
            ...
            {selectedWorkspace?.is_home && (
              <div className="text-sm font-light">
                {t("Este es tu espacio de trabajo en casa para uso personal.")}
              </div>
            )}
          </SheetHeader>
          ...
          <Tabs defaultValue="main">
            <TabsList className="mt-4 grid w-full grid-cols-2">
              <TabsTrigger value="main">Básica</TabsTrigger>
              <TabsTrigger value="defaults">Modelo</TabsTrigger>
            </TabsList>
            ...
            <TabsContent className="mt-4 space-y-4" value="main">
              ...
              <div className="space-y-1">
                <Label>
                  {t(
                    "¿Cómo le gustaría que respondiera la IA en este workspace?"
                  )}
                </Label>
            ...
            <TabsContent className="mt-5" value="defaults">
              <div className="mb-4 text-sm">
                Estas son las configuraciones con las que comienza su espacio de
                trabajo al seleccionarlo.
              </div>
