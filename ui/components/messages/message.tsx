            ...
            <div className="flex items-center space-x-3">
              {message.role === "assistant" ? (
                messageAssistantImage ? (
                  ...
                  <WithTooltip
                    display={<div>{MODEL_DATA?.modelName ?? "Asistente"}</div>}
                    trigger={
                      <ModelIcon
                ...
                {message.role === "assistant"
                  ? message.assistant_id
                    ...
                    : selectedAssistant
                      ...
                      : MODEL_DATA?.modelName ?? "Asistente"
          ...
          <div className="border-primary mt-6 border-t pt-4 font-bold">
            {!viewSources ? (
              ...
              >
                ...
                {Object.keys(fileSummary).length > 1
                  ? t("Archivos")
                  : t("Archivo")}{" "}
