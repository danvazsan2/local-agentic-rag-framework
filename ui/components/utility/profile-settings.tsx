        ...
        <div className="grow overflow-auto">
          <SheetHeader>
            <SheetTitle className="flex items-center justify-between space-x-2">
              <div>{t("Configuración de usuario")}</div>
          ...
          <Tabs defaultValue="profile">
            ...
            <TabsContent className="mt-4 space-y-4" value="profile">
              ...
              <div className="space-y-1">
                <Label>{t("Imagen de Perfil")}</Label>
              ...
              <div className="space-y-1">
                <Label>{t("Nombre para mostrar en el chat")}</Label>

                <Input
                  placeholder={t("Nombre para mostrar en el chat...")}
                  value={displayName}
              ...
              <div className="space-y-1">
                <Label className="text-sm">
                  ¿Qué te gustaría que la IA supiera sobre ti para ofrecerte
                  mejores respuestas?
                </Label>
                ...
                <TextareaAutosize
                  ...
                  placeholder="Contexto del perfil... (opcional)"
                  minRows={6}
                  maxRows={10}
                />
            ...
            <TabsContent className="mt-4 space-y-4" value="keys">
              <div className="mt-5 space-y-2">
                ...
                {useAzureOpenai ? (
                  <>
                    {envKeyMap["azure"] ? (
                      <Label>
                        Clave API de Azure OpenAI establecida por el
                        administrador.
                      </Label>
                    ) : (
                      <Input
                        placeholder="Clave API de Azure OpenAI"
                        type="password"
                  ...
                  <>
                    {envKeyMap["openai"] ? (
                      <Label>
                        Clave API de OpenAI establecida por el administrador.
                      </Label>
                    ) : (
                      <Input
                      ...
                      <div className="space-y-1">
                        {envKeyMap["azure_openai_endpoint"] ? (
                          <Label className="text-xs">
                            Endpoint de Azure establecido por el administrador.
                          </Label>
                        ) : (
                          <>
                            <Label>Endpoint de Azure</Label>
...

                    {
                      <div className="space-y-1">
                        {envKeyMap["azure_gpt_35_turbo_name"] ? (
                          <Label className="text-xs">
                            Nombre de implementación de Azure GPT-3.5 Turbo
                          ...
                          <>
                            ...
                            <Input
                              placeholder="Nombre de implementación de Azure GPT-3.5 Turbo"
...

                    {
                      <div className="space-y-1">
                        {envKeyMap["azure_gpt_45_turbo_name"] ? (
                          <Label className="text-xs">
                            Nombre de implementación de Azure GPT-4.5 Turbo
                            establecido por el administrador.
                          </Label>
                        ) : (
                          <>
                            ...
                            <Input
                              placeholder="Nombre de implementación de Azure GPT-4.5 Turbo"
...

                    {
                      <div className="space-y-1">
                        {envKeyMap["azure_gpt_45_vision_name"] ? (
                          <Label className="text-xs">
                            Nombre de implementación de Azure GPT-4.5 Vision
                            establecido por el administrador.
                          </Label>
                        ) : (
                          <>
                            ...
                            <Input
                              placeholder="Nombre de implementación de Azure GPT-4.5 Vision"
...

                    {
                      <div className="space-y-1">
                        {envKeyMap["azure_embeddings_name"] ? (
                          <Label className="text-xs">
                            Nombre de implementación de Azure Embeddings
                            establecido por el administrador.
                          </Label>
                        ) : (
                          <>
                            ...
                            <Input
                              placeholder="Nombre de implementación de Azure Embeddings"
                  ...
                  <>
                    <div className="space-y-1">
                      {envKeyMap["openai_organization_id"] ? (
                        <Label className="text-xs">
                          ID de organización de OpenAI establecida por el
                          administrador.
                        </Label>
                      ) : (
                        <>
                          <Label>ID de organización de OpenAI</Label>

                          <Input
                            placeholder="ID de organización de OpenAI (opcional)"
                            disabled={
              ...
              <div className="space-y-1">
                {envKeyMap["anthropic"] ? (
                  <Label>
                    Clave API de Anthropic establecida por el administrador.
                  </Label>
                ) : (
                  <>
              ...
              <div className="space-y-1">
                {envKeyMap["google"] ? (
                  <Label>
                    Clave API de Google Gemini establecida por el administrador.
                  </Label>
                ) : (
                  <>
                    <Label>Clave API de Google Gemini</Label>
                    <Input
              ...
              <div className="space-y-1">
                {envKeyMap["mistral"] ? (
                  <Label>
                    Clave API de Mistral establecida por el administrador.
                  </Label>
                ) : (
                  <>
                    <Label>Clave API de Mistral</Label>
                    <Input
                      placeholder="Clave API de Mistral"
                      type="password"
                      value={mistralAPIKey}
              ...
              <div className="space-y-1">
                {envKeyMap["groq"] ? (
                  <Label>
                    Clave API de Groq establecida por el administrador.
                  </Label>
                ) : (
                  <>
              ...
              <div className="space-y-1">
                {envKeyMap["perplexity"] ? (
                  <Label>
                    Clave API de Perplexity establecida por el administrador.
                  </Label>
                ) : (
                  <>
                    <Label>Clave API de Perplexity</Label>
                    <Input
                      placeholder="Clave API de Perplexity"
                      type="password"
              ...
              <div className="space-y-1">
                {envKeyMap["openrouter"] ? (
                  <Label>
                    Clave API de OpenRouter establecida por el administrador.
                  </Label>
                ) : (
                  <>
                    <Label>Clave API de OpenRouter</Label>
                    <Input
                      placeholder="Clave API de OpenRouter"
                      type="password"
        ...
        <div className="mt-6 flex items-center">
          <div className="flex items-center space-x-1">
            ...
            <WithTooltip
              display={
                <div>
                  Descarga los datos de TFG Chatbot 1.0 en formato JSON.
