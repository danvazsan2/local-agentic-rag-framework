...
export const GlobalState: FC<GlobalStateProps> = ({ children }) => {
  ...
  const [ragServerStatus, setRagServerStatus] =
    useState<RagServerStatus>("unknown")
  const [ragIsConfigured, setRagIsConfigured] = useState<boolean>(false)
  const [pendingRagConfig, setPendingRagConfig] = useState<PendingRagConfig>(
    DEFAULT_PENDING_CONFIG
  )
  ...
  useEffect(() => {
    ;(async () => {
      // Cargar modelos de Ollama independientemente del estado del usuario
