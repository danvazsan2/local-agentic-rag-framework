    ...
    <div className="space-y-6">
      <div className="mt-5 space-y-2">
        <Label className="flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <Button
            className="h-8 w-full text-xs sm:w-[150px] sm:text-[11px]"
      ...
      <div className="ml-0 space-y-4 sm:ml-8">
        {useAzureOpenai ? (
          <>
            ...
            <div className="space-y-2">
              <Label className="text-sm sm:text-base">
                Azure OpenAI GPT-4.5 Vision ID
              </Label>
          ...
          <>
            <div className="space-y-2">
              <Label className="text-sm sm:text-base">
                OpenAI Organización ID
              </Label>

              <Input
                className="text-sm sm:text-base"
                placeholder="OpenAI Organización ID (opcional)"
                type="password"
                value={openaiOrgID}
      ...
      <div className="space-y-2">
        <Label className="text-sm sm:text-base">Anthropic API Key</Label>
      ...
      <div className="space-y-2">
        <Label className="text-sm sm:text-base">Google Gemini API Key</Label>
      ...
      <div className="space-y-2">
        <Label className="text-sm sm:text-base">Mistral API Key</Label>
      ...
      <div className="space-y-2">
        <Label className="text-sm sm:text-base">Groq API Key</Label>
      ...
      <div className="space-y-2">
        <Label className="text-sm sm:text-base">Perplexity API Key</Label>
      ...
      <div className="space-y-2">
        <Label className="text-sm sm:text-base">OpenRouter API Key</Label>
