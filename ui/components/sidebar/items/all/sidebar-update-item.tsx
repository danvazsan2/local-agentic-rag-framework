...
export const SidebarUpdateItem: FC<SidebarUpdateItemProps> = ({
  ...
  const handleUpdate = async () => {
    try {
      ...
      toast.success(`${contentType.slice(0, -1)} actualizado exitosamente`)
    } catch (error) {
      toast.error(`Error al actualizar ${contentType.slice(0, -1)}. ${error}`)
    }
  }
          ...
          <div className="mt-4 space-y-3">
            {workspaces.length > 1 && (
              <div className="space-y-1">
                <Label>Workspaces Asignados</Label>
