        ...
        <div>
          {model.provider !== "ollama" && model.pricing && (
            <div className="space-y-1 text-sm">
              <div>
                <span className="font-semibold">Costo por input:</span>{" "}
                {model.pricing.inputCost} {model.pricing.currency} por{" "}
                {model.pricing.unit}
              </div>
              {model.pricing.outputCost && (
                <div>
                  <span className="font-semibold">Costo por output:</span>{" "}
                  {model.pricing.outputCost} {model.pricing.currency} por{" "}
                  {model.pricing.unit}
                </div>
              )}
            </div>
