    ...
    combinedMessageFiles.length > 0 && (
      <div className="flex w-full items-center justify-center space-x-2">
        ...
        >
          ...
          <div>
            {" "}
            Ver {combinedMessageFiles.length} archivo
    ...
    <div className="flex items-center">
      <WithTooltip
        ...
        display={
          <div>
            {useRetrieval
              ? "La recuperación de archivos está habilitada en los archivos seleccionados para este mensaje. Haga clic en el indicador para desactivarla."
              : "Haga clic en el indicador para habilitar la recuperación de archivos para este mensaje."}
          </div>
        }
        trigger={
          <IconCircleFilled
