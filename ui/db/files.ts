...
/**
 * Create a file record without processing embeddings.
 * Used when the custom RAG system will handle the file processing.
 */
export const createFileWithoutProcessing = async (
  file: File,
  fileRecord: TablesInsert<"files">,
  workspace_id: string
) => {
  ...
  // Note: We skip the /api/retrieval/process call here
  // The custom RAG system will handle file processing separately
